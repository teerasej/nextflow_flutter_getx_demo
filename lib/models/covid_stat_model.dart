...
CovidStatModel covidStatModelFromJson(String str) =>
    CovidStatModel.fromJson(json.decode(str));

String covidStatModelToJson(CovidStatModel data) => json.encode(data.toJson());
